...
class Ventas(BaseModel):
    ...
    libro = models.ForeignKey(Libros, on_delete=models.CASCADE, verbose_name=u'Libro')
    ...
    def __str__(self):
        return f'Venta de {self.libro.nombre} a {self.cliente.nombre}' \
               f' {self.cliente.apellido}'
